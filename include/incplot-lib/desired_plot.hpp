...
public:
    DesiredPlot(DP_CtorStruct &&dp_struct)
        : plot_type_name(std::move(dp_struct.plot_type_name)),
          cat_colID(std::move(dp_struct.c_colID)),
          cat_colName(std::move(dp_struct.c_colName)),
          labelTS_colID(std::move(dp_struct.lts_colID)),
          labelTS_colName(std::move(dp_struct.lts_colName)),
          values_colIDs(std::move(dp_struct.v_colIDs)),
          values_colNames(std::move(dp_struct.v_colNames)),
          targetWidth(std::move(dp_struct.tar_width)),
          targetHeight(std::move(dp_struct.tar_height)),
          availableWidth(std::move(dp_struct.availableWidth)),
          availableHeight(std::move(dp_struct.availableHeight)),
          colScheme(std::move(dp_struct.colScheme)),
          ...
          color_basePalette(std::move(dp_struct.colors)),
          ...
          htmlMode_fontSize(std::move(dp_struct.htmlMode_fontSize)),
          forceRGB_bool(std::move(dp_struct.forceRGB_bool)),
    ...
    DesiredPlot(DP_CtorStruct const &dp_struct)
        : plot_type_name(dp_struct.plot_type_name),
          cat_colID(dp_struct.c_colID),
          cat_colName(dp_struct.c_colName),
          labelTS_colID(dp_struct.lts_colID),
          labelTS_colName(dp_struct.lts_colName),
          values_colIDs(dp_struct.v_colIDs),
          values_colNames(dp_struct.v_colNames),
          targetWidth(dp_struct.tar_width),
          targetHeight(dp_struct.tar_height),
          availableWidth(dp_struct.availableWidth),
          availableHeight(dp_struct.availableHeight),
          colScheme(dp_struct.colScheme),
          colOrder(dp_struct.colOrder),
          ...
          color_basePalette(dp_struct.colors),
          color_bckgrndPalette(dp_struct.color_bckgrnd),
          filter_outsideStdDev(dp_struct.filter_outsideStdDev),
          display_filtered_bool(dp_struct.display_filtered_bool),
          htmlMode_bool(dp_struct.htmlMode_bool),
          htmlModeCanvas_bool(dp_struct.htmlModeCanvas_bool),
          htmlMode_fontSize(dp_struct.htmlMode_fontSize),
          forceRGB_bool(dp_struct.forceRGB_bool),
          additionalInfo(dp_struct.additionalInfo),
