...
enum class Unexp_plotSpecs {
    ...
    GTSC_selectedTScolNotFoundInData,
    GTSC_selectedTScolIsNotTimeSeriesLike,
    GTSC_cantSelectTSColToBeTheSameAsCatCol,
    GTSC_cantSelectTSColToBeOneOfTheValCols,
    ...
    GVC_selectedMoreThan3YvalColForScatter,
